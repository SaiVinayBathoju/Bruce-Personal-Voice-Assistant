...
print("----Welcome to Our Project Personal voice Assistant - Bruce----")
wishMe()
speak("Hello vinay, I am your Personal assistant Bruce!")
...
if __name__ == "__main__":
    while True:
        ...
        if 'how are you' in query:
        ...
        elif 'hello' in query or 'hello Bruce' in query or 'Hi Bruce' in query or 'Bruce' in query or 'hey Bruce' in query:
            wishMe()
            speak('Hello Sir! How can I help you?')

        elif 'who are you' in query or 'define yourself' in query:
            speak('Hello Sir, I am Bruce. Your personal Assistant created by Vinay". I am here to make your life easier.')

        elif 'who is your developer' in query or 'who is your designer' in query:
            speak('Mr. Vinay is developed me.')
            ...
            speak("I was created as a Minor project by Mister vinay") 
